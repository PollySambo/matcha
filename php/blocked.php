...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="../css/blocked.css" />
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mt-4">
                <div class="card card-inverse card-info">
                    ...
                    <div class="card-block">
                        ...
                        <h4 class="card-title">Polite Sambo</h4>
                        <div class="card-text">
                            Polite is a web designer living in  Johannesburg.
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mt-4">
                <div class="card card-inverse card-info">
                    ...
                    <div class="card-block">
                        ...
                        <h4 class="card-title">Mbali</h4>
                        <div class="card-text">
                            Mbali is a dancer living in  Johannesburg.
                        </div>
                    </div>
                    <div class="card-footer">
                        <button id="p" class="btn btn-info btn-sm">Unblock</button>
             ...
             <div class="col-sm-6 col-md-4 col-lg-3 mt-4">
                <div class="card card-inverse card-info">
                    ...
                    <div class="card-block">
                        ...
                        <h4 class="card-title">Thembi</h4>
                        <div class="card-text">
                           Thembi is a lawyer living in  Johannesburg.
                        </div>
                    </div>
                    <div class="card-footer">
                        <button id="p" class="btn btn-info btn-sm">Unblock</button>
